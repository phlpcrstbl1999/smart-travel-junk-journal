...
const map = L.map('moa-map', { scrollWheelZoom: false }).setView([14.5350,120.9820], 14);
...
[
  { coords:[14.5350,120.9820], icon:'🛍️', tag:'Mall', tc:'tag--main', name:'SM Mall of Asia', desc:'One of the largest malls in the world — an entertainment complex on Manila Bay with an outdoor promenade and legendary sunset views.' },
  { coords:[14.5350,120.9800], icon:'🌅', tag:'Promenade', tc:'tag--nature', name:'MOA Bayside Promenade', desc:'The outdoor promenade facing Manila Bay — one of the best sunset spots in Metro Manila.' },
