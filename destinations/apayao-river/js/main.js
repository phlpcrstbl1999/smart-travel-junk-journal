...
const map = L.map('apayao-river-map', { scrollWheelZoom: false }).setView([18.0500,121.1500], 10);
...
[
  { coords:[18.0500,121.1500], icon:'🌊', tag:'River', tc:'tag--main', name:'Apayao River', desc:'One of the most pristine river systems in the Philippines — crystal-clear water, ancient forests, and indigenous Isneg communities along its banks.' },
  { coords:[18.0800,121.1800], icon:'💧', tag:'Waterfall', tc:'tag--nature', name:'Puting Bato Falls', desc:'White Rock Falls — brilliant white limestone and turquoise pools in Luna, Apayao.' },
  ...
  { coords:[18.0500,121.1500], icon:'📍', tag:'Town', tc:'tag--heritage', name:'Kabugao', desc:'Capital of Apayao province — the base for all Apayao river adventures.' },
