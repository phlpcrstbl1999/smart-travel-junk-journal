...
const map = L.map('rizal-park-map', { scrollWheelZoom: false }).setView([14.5831,120.9794], 15);
...
[
  { coords:[14.5831,120.9794], icon:'🌳', tag:'Park', tc:'tag--nature', name:'Rizal Park (Luneta)', desc:'The national park of the Philippines — where José Rizal was executed on December 30, 1896. The Rizal Monument stands at the center.' },
  { coords:[14.5921,120.9742], icon:'⚔️', tag:'Heritage', tc:'tag--heritage', name:'Fort Santiago', desc:'A 16th-century citadel where Rizal was imprisoned before his execution.' },
  { coords:[14.5876,120.9820], icon:'🏛️', tag:'Museum', tc:'tag--main', name:'National Museum of the Philippines', desc:'Free admission — world-class collections including Juan Luna\'s Spoliarium.' },
