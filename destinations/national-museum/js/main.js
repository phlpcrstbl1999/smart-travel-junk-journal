...
const map = L.map('national-museum-map', { scrollWheelZoom: false }).setView([14.5876,120.9820], 16);
...
[
  { coords:[14.5876,120.9820], icon:'🏛️', tag:'Museum', tc:'tag--main', name:'National Museum of Fine Arts', desc:'The main building — home to Juan Luna\'s Spoliarium and the finest collection of Philippine fine arts.' },
  { coords:[14.5870,120.9830], icon:'🦕', tag:'Museum', tc:'tag--main', name:'National Museum of Natural History', desc:'The stunning domed building housing the Tree of Life installation and natural history collections.' },
  { coords:[14.5831,120.9794], icon:'🌳', tag:'Park', tc:'tag--nature', name:'Rizal Park', desc:'The national park — adjacent to the National Museum complex.' },
