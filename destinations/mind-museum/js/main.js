...
const map = L.map('mind-museum-map', { scrollWheelZoom: false }).setView([14.5510,121.0490], 15);
...
[
  { coords:[14.5510,121.0490], icon:'🔬', tag:'Museum', tc:'tag--main', name:'The Mind Museum', desc:'The Philippines\' premier science museum — 250+ interactive exhibits across five galleries in Bonifacio Global City.' },
  { coords:[14.5500,121.0500], icon:'🏙️', tag:'District', tc:'tag--heritage', name:'Bonifacio Global City', desc:'The Philippines\' most modern urban district — walkable streets, world-class dining, and Bonifacio High Street.' },
