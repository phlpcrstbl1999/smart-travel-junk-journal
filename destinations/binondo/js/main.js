...
const map = L.map('binondo-map', { scrollWheelZoom: false }).setView([14.5990,120.9730], 15);
...
[
  { coords:[14.5990,120.9730], icon:'🏮', tag:'Chinatown', tc:'tag--main', name:'Binondo', desc:'The world\'s oldest Chinatown — founded in 1594, a labyrinth of food stalls, temples, and 400 years of Chinese-Filipino culture.' },
  { coords:[14.5993,120.9784], icon:'⛪', tag:'Heritage', tc:'tag--heritage', name:'Minor Basilica of San Lorenzo Ruiz', desc:'The patron church of Binondo — dedicated to Lorenzo Ruiz, the first Filipino saint.' },
  { coords:[14.5990,120.9810], icon:'🌉', tag:'Landmark', tc:'tag--nature', name:'Jones Bridge', desc:'A historic bridge over the Pasig River connecting Binondo to Intramuros.' },
