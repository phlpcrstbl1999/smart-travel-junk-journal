...
const map = L.map('bgc-map', { scrollWheelZoom: false }).setView([14.5500,121.0500], 14);
...
[
  { coords:[14.5500,121.0500], icon:'🏙️', tag:'District', tc:'tag--main', name:'Bonifacio Global City', desc:'The Philippines\' most modern urban district — walkable streets, world-class dining, The Mind Museum, and Bonifacio High Street.' },
  { coords:[14.5510,121.0490], icon:'🔬', tag:'Museum', tc:'tag--heritage', name:'The Mind Museum', desc:'The Philippines\' premier science museum — 250+ interactive exhibits across five galleries.' },
  { coords:[14.5480,121.0510], icon:'🛍️', tag:'Shopping', tc:'tag--nature', name:'Bonifacio High Street', desc:'BGC\'s open-air lifestyle strip — restaurants, boutiques, art installations, and weekend markets.' },
