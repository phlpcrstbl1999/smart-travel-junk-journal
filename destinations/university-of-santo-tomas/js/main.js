...
const map = L.map('ust-map', { scrollWheelZoom: false }).setView([14.6096,120.9893], 16);
...
[
  { coords:[14.6096,120.9893], icon:'🎓', tag:'University', tc:'tag--main', name:'University of Santo Tomas', desc:'The oldest existing university in Asia, founded in 1611 — older than Harvard. The Main Building, UST Museum, and the Arch of the Centuries.' },
  { coords:[14.6096,120.9880], icon:'🏛️', tag:'Heritage', tc:'tag--heritage', name:'Arch of the Centuries', desc:'A 17th-century stone arch — the oldest existing arch in the Philippines, built in 1611.' },
