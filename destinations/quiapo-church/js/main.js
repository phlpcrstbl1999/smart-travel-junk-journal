...
const map = L.map('quiapo-map', { scrollWheelZoom: false }).setView([14.5990,120.9840], 16);
...
[
  { coords:[14.5990,120.9840], icon:'⛪', tag:'Church', tc:'tag--heritage', name:'Quiapo Church', desc:'Home of the Black Nazarene — the most venerated image in the Philippines, drawing millions to the Traslacion procession every January 9.' },
  { coords:[14.5990,120.9730], icon:'🏮', tag:'Chinatown', tc:'tag--main', name:'Binondo', desc:'The world\'s oldest Chinatown — a short walk from Quiapo across the Pasig River.' },
